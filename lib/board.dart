...
import 'package:mobiluygulama_1/piece.dart';
import 'package:mobiluygulama_1/pixel.dart';
import 'package:mobiluygulama_1/values.dart';


List<List<Tetriso?>> gameBoard = List.generate(colLength, (i)=> List.generate(rowLength, (j)=>null));
...
class _GameBoardState extends State<GameBoard> {
  ...
  Piece currentPiece = Piece(type: Tetriso.O);
  ...
  void showGameOverDialog(){
    showDialog(context: context, builder: (context)=> AlertDialog(
      title: Text('Game Over'),content: Text("Your score is: $currentScore"),
      actions: [
  ...
  void createNewPiece(){
      ...
      Tetriso randomType = Tetriso.values[rand.nextInt(Tetriso.values.length)];
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context,index) {
              ...
              if (currentPiece.position.contains(index)){
                ...
                final Tetriso? tetrisoType = gameBoard[row][col];
                return Pixel(color: tetrisoColors[tetrisoType]);
              } 
              else {
